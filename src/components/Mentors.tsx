  ...
  return (
    <section id="mentors" className="relative w-full">
      <div className="w-full space-y-24">
        ...
        >
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-black uppercase">
            Advisors & Mentors
          </h2>
          <p className="text-xl md:text-2xl text-black/80 w-full max-w-3xl mx-auto">
        ...
        <div className="relative pb-24">
          {mentorMembers.map((member, index) => (
            <div
              key={index}
              className="sticky transition-all duration-300 ease-in-out w-full h-screen flex justify-center items-center bg-white border-t border-neutral-200 shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.08)] rounded-t-[2.5rem]"
              style={{
                top: 0,
                zIndex: index,
              }}
              ...
              >
                <div className="flex-shrink-0 relative group w-48 md:w-64 lg:w-80 aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 shadow-2xl z-10 bg-secondary/20 flex items-center justify-center">
                  ...
                  {member.image ? (
                    ...
                    <span className="text-8xl font-semibold text-black/50 relative z-10">
                  ...
                  <div className="absolute inset-0 z-20 bg-transparent/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    ...
                    >
                      <Linkedin className="w-10 h-10 text-black group-hover/icon:text-[#0a66c2] transition-colors duration-300" />
                    </a>
                  </div>
                </div>
                <div
                ...
                >
                  <h3 className="text-3xl md:text-[2rem] font-semibold tracking-tighter text-black uppercase leading-[1.2]">
                    {member.name}
                  </h3>
                  <p className="font-['Cormorant_SC'] text-sm md:text-base text-black/80 font-normal uppercase tracking-[0.25em]">
                    {member.role}
                  </p>
                  <p className="text-[1.15rem] text-black/80 leading-[1.9] max-w-3xl mt-6 font-normal">
                    {member.bio}
                  </p>
                </div>
              </div>
